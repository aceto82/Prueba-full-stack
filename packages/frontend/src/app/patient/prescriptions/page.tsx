    ...
    <AuthGuard role="patient">
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-6">
          <h1 className="text-xl font-semibold text-gray-900 mb-6">Mis Prescripciones</h1>
          ...
          {!loading && !error && prescriptions.length === 0 && (
            <div className="text-center py-16">
              <p className="text-gray-500">No tienes prescripciones disponibles.</p>
            </div>
          )}
              ...
              {prescriptions.map((p) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Dr. {p.author.user.name}</p>
                  </div>
