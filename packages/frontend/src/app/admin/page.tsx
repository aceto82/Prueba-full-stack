  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-5">
      ...
      {loading ? (
        ...
        <p className="text-3xl font-semibold text-gray-900">{value.toLocaleString('es-ES')}</p>
      )}
    </div>
  );
}
        ...
        <main className="flex-1 max-w-5xl mx-auto w-full px-4 py-6 space-y-6">
          ...
          <section>
            ...
            {loading ? (
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      ...
                      <th className="text-left px-4 py-2 text-gray-600 font-medium">Doctor</th>
              ...
              <p className="text-sm text-gray-500">Sin datos en el período seleccionado.</p>
            )}
          </section>
                  ...
                  <tbody>
                    {metrics.byDay.map((d) => (
                      <tr key={d.date} className="border-b border-gray-100 last:border-0">
                        ...
                        <td className="px-4 py-2 text-right font-medium text-gray-900">{d.count}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
