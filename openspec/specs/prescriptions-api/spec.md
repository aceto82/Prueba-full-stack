...
Defines the full lifecycle of prescriptions: creation by doctors, listing and detail retrieval with role-based access, consumption by patients, PDF download, and admin-level listing with filters.
