...
## Purpose
HTTP API surface for authentication in the prescription app. Covers login, registration, token refresh, profile retrieval, logout, and the global error response shape.
