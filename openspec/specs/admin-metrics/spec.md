...
Provides aggregated operational metrics to admin users, including totals, prescription status breakdowns, daily activity, and top doctors by prescription volume.
