# filter-querystring-sync Specification

## Purpose
Provides a shared `useFilterParams` hook that synchronises filter state with URL query params, enabling URL persistence and shareable filtered views across the application.
